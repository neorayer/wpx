...
<td align="left" id="title_Font1">管理端IP白名单</td>
...
function cr(){
	...
	var dataSourceProps = {
		listURL: "../ipcontrol/listAdminWhiteip.json",
		addURL: "../ipcontrol/addAdminWhite.json",
		delURL: "../ipcontrol/delAdminWhiteIP.json"
	}
	...
	function delip(){
		...
		var url = "../ipcontrol/delAdminWhiteIP.json?" + uuids;
