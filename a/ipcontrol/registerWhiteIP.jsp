...
<td align="left" id="title_Font1">注册端IP白名单</td>
...
function cr(){
	...
	var dataSourceProps = {
		listURL: "../ipcontrol/listregisterWhiteIP.json",
		addURL: "../ipcontrol/addregisterWhiteIP.json"
	}
	...
	function delip(){
		...
		var url = "../ipcontrol/delregisterWhiteIP.json?" + uuids;
