...
<div class="pgHeadBlock">
	...
	<tr>
		...
		<td align="left" id="title_Font1">私人通讯录成员导入</td>
...
<div id="importBlock">
	<br><br>
	<form method="post" action="importPsnAddrbooks.sjs" enctype="multipart/form-data">
		<table align="left">
	...
	<div class="desc">
		<h2>说明</h2>
		<p>上传的私人通讯录成员列表格式如下：</p>
		<p>组ID1,所有人 ......</p>
		<p>组ID2,所有人 ......</p>
		<p>组ID3,所有人 ......</p>
		<br>
		<p>每一行是一个私人通讯录成员的信息，各字段的顺序是</p>
		<p>组ID,所有人,邮件地址,真实姓名,单位名称,部门名称,职务,电话,手机</p>
		<p>groupId,owner,mail,displayName,company,ou,title,phone,mobile</p>
		<p>不用导入的字段可忽略。</p>
		<p>各字段间以逗号(,)隔开。 </p>
	</div>
	...
	<br><br>
	<hr/>
	<a class="export" href="exportPsnAddrbooks.down">导出所有私人通讯录成员</a>
</div>
</body>
</html>