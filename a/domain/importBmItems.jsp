...
<div class="pgHeadBlock">
	...
	<tr>
		...
		<td align="left" id="title_Font1">书签导入</td>
...
<div id="importBlock">
	<br><br>
	<form method="post" action="importBmItems.sjs" enctype="multipart/form-data">
		<table align="left">
	...
	<div class="desc">
		...
		<p>书签3,描述 ......</p>
		<br>
		<p>每一行是一个书签的信息，各字段的顺序是</p>
		<p>组名,描述,地址,所有人</p>
		<p>name,description,url,owner</p>
		<p>不用导入的字段可忽略。</p>
		<p>各字段间以逗号(,)隔开。 </p>
	</div>
	...
	<br><br>
	<hr/>
	<a class="export" href="exportBmItems.down">导出所有书签组</a>
</div>
</body>
</html>