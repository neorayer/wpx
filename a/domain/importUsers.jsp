...
<div id="importBlock">
	<br><br>
	<form method="post" action="importUsers.sjs" enctype="multipart/form-data">
		<table align="left">
	...
	<div class="desc">
		...
		<p>域名3,默认邮箱大小 ......</p>
		<br>
		<p>每一行是一个用户的信息，各字段的顺序是</p>
		<p>用户名,域名,密码,真实姓名,公司名称,部门名称,性别,职务,大小</p>
		<p>uid,dc,userPassword,displayName,company,<span style="color:red;">deptName</span>,sex,title,size</p>
		<p>不用导入的字段可忽略。</p>
		<p>各字段间以逗号(,)隔开。 </p>
	</div>
	...
	<br><br>
	<hr/>
	<a class="export" href="exportUsers.down">导出所有用户</a>
</div>
</body>
</html>