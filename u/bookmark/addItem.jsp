...
<div class="folder-box">
	...
	<form id="addForderForm" action="bookmark/addItem.json" method="post">
		<table>
			<tr>
				<td>书签名称：</td>
				<td>
			...
			<tr>
				<td>书签地址：</td>
				<td><input class="text" type="text" name="url" value="http://"></td>
			</tr>
			<tr>
				<td>书签描述：</td>
				<td>
					<textarea class="text" name="description" rows="16" cols="80"></textarea>					
				</td>
			</tr>
			<tr>
